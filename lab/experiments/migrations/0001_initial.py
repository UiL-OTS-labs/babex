...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name_form', models.TextField(verbose_name='criterion:attribute:name_form')),
                ('name_natural', models.TextField(verbose_name='criterion:attribute:name_natural')),
                ('values', models.TextField(verbose_name='criterion:attribute:values')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='ExperimentCriterion',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('correct_value', models.TextField(verbose_name='experiment_criterion:attribute:correct_value')),
                ('message_failed', models.TextField(verbose_name='experiment_criterion:attribute:message_failed')),
            ],
        ),
        migrations.CreateModel(
            name='Location',
